...
INSERT INTO Pessoa(idPessoa,nome,logradouro,cidade,estado,telefone,email)
	VALUES(NEXT VALUE FOR orderPessoa, 'João Silva', 'Rua das Flores, 123', 'São Paulo', 'SP', '11987654321', 'joao.silva@example.com'),
	(NEXT VALUE FOR orderPessoa,'Maria Oliveira', 'Avenida Paulista, 456', 'São Paulo', 'SP', '11987654322', 'maria.oliveira@example.com'),
	(NEXT VALUE FOR orderPessoa,'Pedro Santos', 'Praça da Sé, 789', 'Rio de Janeiro', 'RJ', '21987654323', 'pedro.santos@example.com'),
